...
import { MainWalletSection } from './components/MainWalletSection';
import { AIWalletSection } from './components/AIWalletSection';
...
export const DesktopBalancesPage = () => {
    ...
    return (
      <PortfolioContainer>
        <MainContent>
          ...
          <PageSubtitle>Overview of your holdings in main wallet and AI-agent wallet</PageSubtitle>
        </PageHeader>
          <ProfessionalEmptyState>
            ...
            <ProfessionalEmptyStateText>
              Please connect your wallet to view your balances across your wallets
            </ProfessionalEmptyStateText>
          </ProfessionalEmptyState>
        </MainContent>
      </PortfolioContainer>
