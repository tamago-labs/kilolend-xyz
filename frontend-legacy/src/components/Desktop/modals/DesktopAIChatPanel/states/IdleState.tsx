...
type SetupState = 'no-wallet' | 'no-ai-wallet' | 'ai-wallet-ready' | 'loading' | 'error';
...
export const IdleState: React.FC<IdleStateProps> = ({ 
  ...
  useEffect(() => {
    if (!isLoading && setupState === 'no-ai-wallet') {
  ...
  const checkSetupState = async () => {
    ...
    try {
      ...
      if (!status.hasWallet) {
        ...
        // AI agent already exists - this state shouldn't happen in IdleState
      ...
      case 'no-wallet':
        return (
          <Container>
            ...
            <ActionButton onClick={onToggle} $variant="secondary">
              Close
            </ActionButton>
          </Container>
        );
      ...
      case 'no-ai-wallet':
        ...
        return (
          <Container>
            ...
            <BenefitsSection>
              <BenefitsTitle>What your AI Agent can do:</BenefitsTitle>
              <BenefitsList>
                <BenefitItem>Monitor market conditions 24/7</BenefitItem>
                <BenefitItem>Execute optimized trading strategies</BenefitItem>
                <BenefitItem>Manage your DeFi positions automatically</BenefitItem>
                <BenefitItem>Provide personalized recommendations</BenefitItem>
              </BenefitsList>
            </BenefitsSection>

            <ActionButton 
              onClick={onCreateWallet} 
              disabled={isLoading || isCapacityReached}
            >
              {isCapacityReached ? 'Capacity Full' : isLoading ? (
                <>
      ...
      case 'ai-wallet-ready':
        return (
          <Container>
            ...
            <StatusMessage>
              Your AI-agent wallet is ready! You can now create your AI agent.
            </StatusMessage> 
            <ActionButton onClick={onContinueToSetup} $variant="primary">
              <ArrowRight size={18} />
              Continue to Setup
            </ActionButton>
          </Container>
