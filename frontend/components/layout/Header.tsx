  ...
  return (
    <header className="flex justify-between items-center px-4 md:px-8 bg-white border-b border-[#e2e8f0] sticky top-0 z-50 h-[72px] w-full">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <button className="hidden md:flex items-center justify-center min-w-[140px] md:min-w-[280px] h-12 text-white bg-[#06c755] rounded-xl border-none text-base md:text-lg font-bold cursor-pointer transition-all hover:bg-[#05b54e] hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(6,199,85,0.3)]">
          Connect
        </button>
        ...
        <>
          ...
          <div className="absolute top-[72px] left-0 right-0 bg-white border-b border-[#e2e8f0] shadow-lg z-50 md:hidden">
            <nav className="flex flex-col p-4 gap-2">
              ...
              <button className="w-full h-12 text-white bg-[#06c755] rounded-xl border-none text-lg font-bold cursor-pointer transition-all hover:bg-[#05b54e]">
                Connect
              </button>
            </nav>
          </div>
